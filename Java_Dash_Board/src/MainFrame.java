...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("DashBoard");
        setMinimumSize(new java.awt.Dimension(755, 497));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/group (1).png"))); // NOI18N
        ...
        tclients.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        int row = tclients.getSelectedRow();
        if(row<0){
            JOptionPane.showMessageDialog(this,
